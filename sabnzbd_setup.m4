...
iocage exec __SABNZBD_JAIL__ chown -R __MEDIA_USER__:__MEDIA_USER__ /__MOUNT_LOCATION__/downloads/__SABNZBD_JAIL__ /config

iocage exec __SABNZBD_JAIL__ mkdir -p /__MOUNT_LOCATION__/downloads/__SABNZBD_JAIL__/incomplete
iocage exec __SABNZBD_JAIL__ mkdir -p /__MOUNT_LOCATION__/downloads/__SABNZBD_JAIL__/complete
...
iocage exec __SABNZBD_JAIL__ sed -i '' -e 's?download_dir = Downloads/incomplete?download_dir = /__MOUNT_LOCATION__/downloads/__SABNZBD_JAIL__/incomplete?g' /config/sabnzbd.ini
iocage exec __SABNZBD_JAIL__ sed -i '' -e 's?complete_dir = Downloads/complete?complete_dir = /__MOUNT_LOCATION__/downloads/__SABNZBD_JAIL__/complete?g' /config/sabnzbd.ini
